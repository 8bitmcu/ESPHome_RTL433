...
The device I have it configured for is a [Heltec WiFi LoRa 32 v2](https://heltec.org/project/wifi-lora-32/), but this should work on any device supported by rtl_433_ESP. 
